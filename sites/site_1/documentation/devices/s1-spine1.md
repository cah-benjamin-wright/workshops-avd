...
```eos
!
username arista privilege 15 role network-admin secret sha512 $6$lVf.PbSG3rpw1/TE$ljsTaWfOtRkEdAco.T7dpWIH90AftCBJ4e6Lx//EoH8IfPjs5pCObTAXKDpDerjalqR1/rRGSnpvRPCPxuTek/
```
